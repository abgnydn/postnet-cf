...
| 40-4b-s2 | int8 quantization — `scripts/quantize-qwen-onnx.py` shrinks the Qwen+gates ONNX from 1.8 GB to 866 MB (3.7× faster forward) with top-1 token agreement preserved; int4 deferred (separate tooling) | _uncommitted_ |
