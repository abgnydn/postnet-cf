...
| 40-scope | NTK-Mirror local dry-run + integration plan — Qwen2.5-0.5B + 512 gates trained in 5 s, controller artifact dissected, Phase 40 ship sequence written (see `docs/PHASE_40_NTKMIRROR_PLAN.md`) | _uncommitted_ |
